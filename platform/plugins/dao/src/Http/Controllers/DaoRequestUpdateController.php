...
class DaoRequestUpdateController extends BaseController
{
    ...
    public function index(DaoRequestUpdateTable $table)
    {
        ...
        page_title()->setTitle(trans('plugins/dao::dao-request-update.name'));
    ...
    {
        page_title()->setTitle(trans('plugins/dao::dao-request-update.create'));
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('plugins/dao::dao-request-update.edit') . ' "' . $daoRequestUpdate->name . '"');
