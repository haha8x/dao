...
class DaoRequestNewController extends BaseController
{
    ...
    public function index(DaoRequestNewTable $table)
    {
        ...
        page_title()->setTitle(trans('plugins/dao::dao-request-new.name'));
    ...
    {
        page_title()->setTitle(trans('plugins/dao::dao-request-new.create'));
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('plugins/dao::dao-request-new.edit') . ' "' . $daoRequestNew->name . '"');
