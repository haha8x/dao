...
class RequestHistoryController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('plugins/dao::request-history.name'));
    ...
    {
        page_title()->setTitle(trans('plugins/dao::request-history.create'));
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('plugins/dao::request-history.edit') . ' "' . $requestHistory->name . '"');
