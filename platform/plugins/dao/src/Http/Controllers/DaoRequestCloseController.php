...
class DaoRequestCloseController extends BaseController
{
    ...
    public function index(DaoRequestCloseTable $table)
    {
        ...
        page_title()->setTitle(trans('plugins/dao::dao-request-close.name'));
    ...
    {
        page_title()->setTitle(trans('plugins/dao::dao-request-close.create'));
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('plugins/dao::dao-request-close.edit') . ' "' . $daoRequestClose->name . '"');
