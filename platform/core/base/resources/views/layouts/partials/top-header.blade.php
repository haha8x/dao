...
<div class="page-header-top navbar navbar-inverse" role="navigation" xmlns="http://www.w3.org/1999/html">
    <div class="navbar-header page-logo">
        <a class="navbar-brand" href="{{ route('dashboard.index') }}">
            <img src="{{ setting('admin_logo') ? get_image_url(setting('admin_logo')) : url(config('core.base.general.logo')) }}" alt="logo" class="logo-default" style="max-height: 60px;" />
        </a>
    </div>
    <div class="bic-logo">
    <img src="/storage/bic.png" alt="logo" class="logo-default" style="max-height: 80px;" />
    </div>
