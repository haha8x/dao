        ...
        <div class="page-content-wrapper">
            <div class="page-content @if (Route::currentRouteName() == 'media.index') rv-media-integrate-wrapper @endif">
                <div class="alert alert-info" role="alert">
                    Nếu có vấn đề liên quan đến đăng nhập hoặc cần hỗ trợ thao tác trên hệ thống QUẢN LÝ DAO (10.3.4.5/login), ĐVKD vui lòng email đến địa chỉ hotro_dao_khcn@vpbank.com.vn
                </div>
