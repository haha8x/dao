...
function () {
  ...
  _createClass(Layout, [{
    ...
    value: function handleSidebarAndContentHeight() {
      ...
      if (body.hasClass('page-footer-fixed') === true && body.hasClass('page-sidebar-fixed') === false) {
        ...
        if (body.hasClass('page-sidebar-fixed')) {
          ...
          if (_app__WEBPACK_IMPORTED_MODULE_0__["App"].getViewPort().width < this.resBreakpointMd) {
          ...
          if (height + headerHeight + footerHeight <= _app__WEBPACK_IMPORTED_MODULE_0__["App"].getViewPort().height) {
            height = _app__WEBPACK_IMPORTED_MODULE_0__["App"].getViewPort().height - headerHeight - footerHeight + 34;
          }
        }
    ...
    value: function handleFixedSidebar() {
      ...
      if (_app__WEBPACK_IMPORTED_MODULE_0__["App"].getViewPort().width >= this.resBreakpointMd && !this.$body.hasClass('page-sidebar-menu-not-fixed')) {
    ...
    key: "handleTabs",
    value: function handleTabs() {
      var current = this; // fix content height on tab click
    ...
    value: function handle100HeightContent() {
      ...
      $('.full-height-content').each(function (index, el) {
        var target = $(el);
        var height;
        height = _app__WEBPACK_IMPORTED_MODULE_0__["App"].getViewPort().height - $('.page-header').outerHeight(true) - $('.page-footer').outerHeight(true) - $('.page-title').outerHeight(true) - $('.page-bar').outerHeight(true);
    ...
    value: function initContent() {
      ...
      _app__WEBPACK_IMPORTED_MODULE_0__["App"].addResizeHandler(this.handleSidebarAndContentHeight); // recalculate sidebar & content height on window resize
...
module.exports = __webpack_require__(/*! /home/vagrant/code/dao/platform/core/base/resources/assets/js/core.js */"./platform/core/base/resources/assets/js/core.js");
