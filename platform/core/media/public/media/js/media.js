...
/***/ "./platform/core/media/resources/assets/js/App/Config/ExternalServiceConfig.js":
/*!*************************************************************************************!*\
  !*** ./platform/core/media/resources/assets/js/App/Config/ExternalServiceConfig.js ***!
  \*************************************************************************************/
/*! exports provided: ExternalServiceConfig */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ExternalServiceConfig", function() { return ExternalServiceConfig; });
...
/***/ "./platform/core/media/resources/assets/js/App/Externals/ExternalServices.js":
/*!***********************************************************************************!*\
  !*** ./platform/core/media/resources/assets/js/App/Externals/ExternalServices.js ***!
  \***********************************************************************************/
/*! exports provided: ExternalServices */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ExternalServices", function() { return ExternalServices; });
/* harmony import */ var _Youtube__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Youtube */ "./platform/core/media/resources/assets/js/App/Externals/Youtube.js");
...
var ExternalServices = function ExternalServices() {
  ...
  new _Youtube__WEBPACK_IMPORTED_MODULE_0__["Youtube"]();
};

/***/ }),

/***/ "./platform/core/media/resources/assets/js/App/Externals/Youtube.js":
/*!**************************************************************************!*\
  !*** ./platform/core/media/resources/assets/js/App/Externals/Youtube.js ***!
  \**************************************************************************/
...
/* harmony import */ var _Config_ExternalServiceConfig__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Config/ExternalServiceConfig */ "./platform/core/media/resources/assets/js/App/Config/ExternalServiceConfig.js");
/* harmony import */ var _Services_MediaService__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Services/MediaService */ "./platform/core/media/resources/assets/js/App/Services/MediaService.js");
/* harmony import */ var _Services_MessageService__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Services/MessageService */ "./platform/core/media/resources/assets/js/App/Services/MessageService.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  function Youtube() {
    ...
    this.MediaService = new _Services_MediaService__WEBPACK_IMPORTED_MODULE_2__["MediaService"]();
    this.$body = $('body');
  ...
  _createClass(Youtube, [{
    ...
    value: function checkYouTubeVideo($input) {
      ...
      if (!Youtube.validateYouTubeLink($input.val()) || !_Config_ExternalServiceConfig__WEBPACK_IMPORTED_MODULE_1__["ExternalServiceConfig"].youtube.api_key) {
        if (_Config_ExternalServiceConfig__WEBPACK_IMPORTED_MODULE_1__["ExternalServiceConfig"].youtube.api_key) {
        ...
        $.ajax({
          url: requestUrl + '&key=' + _Config_ExternalServiceConfig__WEBPACK_IMPORTED_MODULE_1__["ExternalServiceConfig"].youtube.api_key + '&part=snippet',
          type: 'GET',
      ...
      function singleVideoCallback(data, url) {
        $.ajax({
          ...
          data: {
            ...
            folder_id: _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_0__["Helpers"].getRequestParams().folder_id,
            url: url,
            options: {
          ...
          success: function success(res) {
            if (res.error) {
              _Services_MessageService__WEBPACK_IMPORTED_MODULE_3__["MessageService"].showMessage('error', res.message, RV_MEDIA_CONFIG.translations.message.error_header);
            } else {
              _Services_MessageService__WEBPACK_IMPORTED_MODULE_3__["MessageService"].showMessage('success', res.message, RV_MEDIA_CONFIG.translations.message.success_header);

              _self.MediaService.getMedia(true);
            }
          },
          error: function error(data) {
            _Services_MessageService__WEBPACK_IMPORTED_MODULE_3__["MessageService"].handleError(data);
          }
        });
...
/* harmony import */ var _Services_MessageService__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Services/MessageService */ "./platform/core/media/resources/assets/js/App/Services/MessageService.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  ...
  _createClass(ActionsService, null, [{
    ...
    value: function handleCopyLink() {
      ...
      _Services_MessageService__WEBPACK_IMPORTED_MODULE_2__["MessageService"].showMessage('success', RV_MEDIA_CONFIG.translations.clipboard.success, RV_MEDIA_CONFIG.translations.message.success_header);
      ...
      switch (type) {
        ...
        case 'download':
          ...
          if (downloadLink !== RV_MEDIA_URL.download) {
            ...
            _Services_MessageService__WEBPACK_IMPORTED_MODULE_2__["MessageService"].showMessage('error', RV_MEDIA_CONFIG.translations.download.error, RV_MEDIA_CONFIG.translations.message.error_header);
          }
    ...
    value: function processAction(data) {
      ...
      $.ajax({
        ...
        success: function success(res) {
          ...
          if (!res.error) {
            _Services_MessageService__WEBPACK_IMPORTED_MODULE_2__["MessageService"].showMessage('success', res.message, RV_MEDIA_CONFIG.translations.message.success_header);
          } else {
            _Services_MessageService__WEBPACK_IMPORTED_MODULE_2__["MessageService"].showMessage('error', res.message, RV_MEDIA_CONFIG.translations.message.error_header);
          }
        ...
        error: function error(data) {
          _Services_MessageService__WEBPACK_IMPORTED_MODULE_2__["MessageService"].handleError(data);
        }
      });
    }
  }, {
...
/* harmony import */ var _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Helpers/Helpers */ "./platform/core/media/resources/assets/js/App/Helpers/Helpers.js");
/* harmony import */ var _Services_MessageService__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Services/MessageService */ "./platform/core/media/resources/assets/js/App/Services/MessageService.js");
/* harmony import */ var _Services_ActionsService__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Services/ActionsService */ "./platform/core/media/resources/assets/js/App/Services/ActionsService.js");
/* harmony import */ var _Services_ContextMenuService__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../Services/ContextMenuService */ "./platform/core/media/resources/assets/js/App/Services/ContextMenuService.js");
...
function () {
  ...
  _createClass(MediaService, [{
    ...
    value: function getMedia() {
      ...
      $.ajax({
        ...
        success: function success(res) {
          ...
          _Services_ActionsService__WEBPACK_IMPORTED_MODULE_3__["ActionsService"].renderActions();
    ...
    value: function refreshFilter() {
      ...
      var view_in = _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__["Helpers"].getRequestParams().view_in;

      if (view_in !== 'all_media' && !_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__["Helpers"].getRequestParams().folder_id) {
      ...
      _Services_ContextMenuService__WEBPACK_IMPORTED_MODULE_4__["ContextMenuService"].destroyContext();
      _Services_ContextMenuService__WEBPACK_IMPORTED_MODULE_4__["ContextMenuService"].initContext();
...
/* harmony import */ var _Services_MediaService__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Services/MediaService */ "./platform/core/media/resources/assets/js/App/Services/MediaService.js");
/* harmony import */ var _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Helpers/Helpers */ "./platform/core/media/resources/assets/js/App/Helpers/Helpers.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  function UploadService() {
    ...
    this.totalQueued = 1;
    this.MediaService = new _Services_MediaService__WEBPACK_IMPORTED_MODULE_0__["MediaService"]();
    this.totalError = 0;
  }
...
/* harmony import */ var _App_Externals_ExternalServices__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./App/Externals/ExternalServices */ "./platform/core/media/resources/assets/js/App/Externals/ExternalServices.js");
...
function () {
  function MediaManagement() {
    ...
    new _App_Externals_ExternalServices__WEBPACK_IMPORTED_MODULE_6__["ExternalServices"]();
    this.$body = $('body');
  }
...
module.exports = __webpack_require__(/*! /home/vagrant/code/dao/platform/core/media/resources/assets/js/media.js */"./platform/core/media/resources/assets/js/media.js");
