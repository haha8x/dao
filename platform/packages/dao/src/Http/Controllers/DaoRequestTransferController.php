...
class DaoRequestTransferController extends BaseController
{
    ...
    public function index(DaoRequestTransferTable $table)
    {
        ...
        page_title()->setTitle(trans('packages/dao::dao-request-transfer.name'));
    ...
    {
        page_title()->setTitle(trans('packages/dao::dao-request-transfer.create'));
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('packages/dao::dao-request-transfer.edit') . ' "' . $daoRequestTransfer->name . '"');
