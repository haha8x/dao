...
class DaoController extends BaseController
{
    ...
    public function index(DaoTable $table)
    {
        ...
        page_title()->setTitle(trans('packages/dao::dao.name'));
    ...
    {
        page_title()->setTitle(trans('packages/dao::dao.create'));
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('packages/dao::dao.edit') . ' "' . $dao->name . '"');
    ...
    public function info($id)
    {
        ...
        return view('packages/dao::index.info', compact('dao'))->render();
    }
}
