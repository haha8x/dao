...
class DaoRequestUpdateController extends BaseController
{
    /**
    ...
    /**
     * DaoRequestUpdateController constructor.
    ...
    public function index(DaoRequestUpdateTable $table)
    {
        ...
        page_title()->setTitle(trans('packages/dao::dao-request-update.name'));
    ...
    {
        page_title()->setTitle(trans('packages/dao::dao-request-update.create'));
    ...
    public function store(DaoRequestUpdateRequest $request, BaseHttpResponse $response)
    {
        ...
        return $response
            ->setPreviousUrl(route('dao-request-update.index'))
            ->setNextUrl(route('dao-request-update.edit', $daoRequestUpdate->id))
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('packages/dao::dao-request-update.edit') . ' "' . $daoRequestUpdate->name . '"');
