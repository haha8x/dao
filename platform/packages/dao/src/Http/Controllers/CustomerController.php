...
class CustomerController extends BaseController
{
    ...
    public function index(CustomerTable $table)
    {
        ...
        page_title()->setTitle(trans('packages/dao::customer.name'));
    ...
    {
        page_title()->setTitle(trans('packages/dao::customer.create'));
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('packages/dao::customer.edit') . ' "' . $customer->name . '"');
