    ...
    public function boot()
    {
        ...
        Event::listen(RouteMatched::class, function () {
            ...
            dashboard_menu()->registerItem([
                ...
                // ->registerItem([
                //     'id'          => 'cms-packages-dao-index',
                //     'priority'    => 1,
                //     'parent_id'   => 'cms-packages-dao',
                ...
                ->registerItem([
                    ...
                    'id'          => 'cms-packages-request-update',
                    'priority'    => 3,
                    'parent_id'   => 'cms-packages-dao',
                    ...
                    'id'          => 'cms-packages-request-transfer',
                    'priority'    => 4,
                    'parent_id'   => 'cms-packages-dao',
