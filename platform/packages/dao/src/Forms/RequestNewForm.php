...
class RequestNewForm extends FormAbstract
{
    ...
    {
        Assets::addScriptsDirectly('vendor/core/packages/catalog/js/catalog.js');
        ...
        $this
            ...
            ->setFormOption('template', 'packages/dao::forms.register.base')
            ->setFormOption('enctype', 'multipart/form-data')
            ->setValidatorClass(RequestNewRequest::class)
            ->setActionButtons(view('packages/dao::forms.register.actions')->render())
            ->add('zone_id', 'select', [
                'label' => __('Vùng'),
