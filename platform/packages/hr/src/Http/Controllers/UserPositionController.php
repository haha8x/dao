...
class UserPositionController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('packages/hr::user-position.name'));
    ...
    {
        page_title()->setTitle(trans('packages/hr::user-position.create'));
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('packages/hr::user-position.edit') . ' "' . $userPosition->name . '"');
