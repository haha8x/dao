...
class CatalogPositionController extends BaseController
{
    ...
    public function index(CatalogPositionTable $table)
    {
        ...
        page_title()->setTitle(trans('packages/catalog::catalog-position.name'));
    ...
    {
        page_title()->setTitle(trans('packages/catalog::catalog-position.create'));
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('packages/catalog::catalog-position.edit') . ' "' . $catalogPosition->name . '"');
