...
class CatalogZoneController extends BaseController
{
    ...
    public function index(CatalogZoneTable $table)
    {
        ...
        page_title()->setTitle(trans('packages/catalog::catalog-zone.name'));
    ...
    {
        page_title()->setTitle(trans('packages/catalog::catalog-zone.create'));
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('packages/catalog::catalog-zone.edit') . ' "' . $catalogZone->name . '"');
