...
class CatalogBranchController extends BaseController
{
    ...
    public function index(CatalogBranchTable $table)
    {
        ...
        page_title()->setTitle(trans('packages/catalog::catalog-branch.name'));
    ...
    {
        page_title()->setTitle(trans('packages/catalog::catalog-branch.create'));
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('packages/catalog::catalog-branch.edit') . ' "' . $catalogBranch->name . '"');
