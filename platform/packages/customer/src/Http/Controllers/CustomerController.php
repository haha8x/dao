...
class CustomerController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('packages/customer::customer.name'));
    ...
    {
        page_title()->setTitle(trans('packages/customer::customer.create'));
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('packages/customer::customer.edit') . ' "' . $customer->name . '"');
