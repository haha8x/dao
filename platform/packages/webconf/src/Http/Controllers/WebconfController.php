...
class WebconfController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('packages/webconf::webconf.name'));
    ...
    {
        page_title()->setTitle(trans('packages/webconf::webconf.create'));
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('packages/webconf::webconf.edit') . ' "' . $webconf->name . '"');
